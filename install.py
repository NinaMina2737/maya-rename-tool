...
####################################################################################################
# About module file
_MODULE_FILE_NAME = "renameTool.mod"
_MODULE_NAME = "renameTool"
_MODULE_VERSION = "v1.0,0"
_SCRIPTS_DIR_NAME = "src"

# About shelf button
_COMMAND = """import maya_rename_tool_ui as scr<COMMAND_NEW_LINE>reload(scr)<COMMAND_NEW_LINE>scr.execute()<COMMAND_NEW_LINE>"""
